...
const CLAIMS = [
  ...
  { id: "insurance_bad_faith", label: "Insurance Bad Faith / Fraudulent Denial", codes: ["Ins. Code § 790.03", "Ins. Code § 790.03(h)", "Civ. Code § 3294", "Brandt v. Superior Court (1985) 37 Cal.3d 813"], category: "Civil" },
];
...
const MOTION_TYPES = [
  ...
  { id: "bad_faith_ins", label: "Insurance Bad Faith – Punitive Damages", authority: "Ins. Code § 790.03(h); Civ. Code § 3294; Brandt v. Superior Court (1985) 37 Cal.3d 813" },
];
